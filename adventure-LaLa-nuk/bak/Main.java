...
public class Main {
	...
	public static void main(String[] args) {
		Game.opening();
		AutoSetOnMap autoSet = new AutoSetOnMap();
		Goblin g = new Goblin("goblin", autoSet);
		Dragon d = new Dragon("dragon", autoSet);
		Potion po = new Potion("potion", autoSet);
		Ether e = new Ether("ether", autoSet);
